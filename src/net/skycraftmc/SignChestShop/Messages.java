...
public class Messages 
{
	...
	public static final String DEFAULT_PRICE_CANCEL = "&eItem pricing cancelled.";
	public static final String DEFAULT_PRICE_SET = "&ePrice set!";
	
	public static final String DEFAULT_CREATE_CANCEL = "&eShop creation cancelled.";
	public static final String DEFAULT_CREATE_SUCCESS = "&eShop created!";
